...
def update_sprite(cat):
    ...
    try:
        ...
        if cat.white_patches is not None:
            if cat.pelt.name == "bat_single":
                if cat.pelt.length == 'long' and cat.status not in ['kitten', 'apprentice', 'medicine cat apprentice',
                                                                    "mediator apprentice"] \
                        or cat.age == 'elder':
                    new_sprite.blit(
                        sprites.sprites['bat_whiteextra' + cat.white_patches +
                                        str(cat.age_sprites[cat.age])], (0, 0))
                else:
                    new_sprite.blit(
                        sprites.sprites['bat_white' + cat.white_patches +
                                        str(cat.age_sprites[cat.age])], (0, 0))
            elif cat.pelt.name == "bat_twocolour":
                if cat.pelt.length == 'long' and cat.status not in ['kitten', 'apprentice', 'medicine cat apprentice',
                                                                    "mediator apprentice"] \
                        or cat.age == 'elder':
                    new_sprite.blit(
                ...
                if cat.pelt.length == 'long' and cat.status not in ['kitten', 'apprentice', 'medicine cat apprentice',
                    ...
                    new_sprite.blit(
                        sprites.sprites['bat_white' + cat.white_patches +
                                        str(cat.age_sprites[cat.age])], (0, 0))
            elif cat.pelt.name == "bat_speckled":
                if cat.pelt.length == 'long' and cat.status not in ['kitten', 'apprentice', 'medicine cat apprentice',
                                                                    "mediator apprentice"] \
                        or cat.age == 'elder':
                    new_sprite.blit(
        ...
        if cat.pelt.name == "bat_single":
            if cat.pelt.length == 'long' and cat.status not in [
                ...
                new_sprite.blit(
                    sprites.sprites['bat_eyesextra' + cat.eye_colour +
                                    str(cat.age_sprites[cat.age])], (0, 0))
                if cat.eye_colour2 != None:
                    new_sprite.blit(
                    sprites.sprites['bat_eyes2extra' + cat.eye_colour2 +
                                    str(cat.age_sprites[cat.age])], (0, 0))
                for scar in cat.scars:
                    if scar in scars1:
                        new_sprite.blit(
                            sprites.sprites['bat_scarsextra' + scar + str(cat.age_sprites[cat.age])],
                            (0, 0)
                        )
                    if scar in scars3:
                        new_sprite.blit(
                ...
                new_sprite.blit(
                    sprites.sprites['bat_eyes' + cat.eye_colour +
                                    str(cat.age_sprites[cat.age])], (0, 0))
                if cat.eye_colour2 != None:
                    new_sprite.blit(
                    sprites.sprites['bat_eyes2' + cat.eye_colour2 +
                                    str(cat.age_sprites[cat.age])], (0, 0))
                for scar in cat.scars:
                    if scar in scars1:
                        new_sprite.blit(
                            sprites.sprites['bat_scars' + scar + str(cat.age_sprites[cat.age])],
                            (0, 0)
                        )
                    if scar in scars3:
                        new_sprite.blit(
            ...
            if cat.pelt.length == 'long' and cat.status not in [
                ...
                new_sprite.blit(
                    sprites.sprites['bat_bat_eyes' + cat.eye_colour +
                                    str(cat.age_sprites[cat.age])], (0, 0))
                if cat.eye_colour2 != None:
                    new_sprite.blit(
                    sprites.sprites['bat_bat_eyes2' + cat.eye_colour2 +
                                    str(cat.age_sprites[cat.age])], (0, 0))
                for scar in cat.scars:
                    if scar in scars1:
                        new_sprite.blit(
            ...
            if cat.pelt.length == 'long' and cat.status not in [
                ...
                new_sprite.blit(
                    sprites.sprites['bat_bat_eyesextra' + cat.eye_colour +
                                    str(cat.age_sprites[cat.age])], (0, 0))
                if cat.eye_colour2 != None:
                    new_sprite.blit(
                    sprites.sprites['bat_bat_eyes2extra' + cat.eye_colour2 +
                                    str(cat.age_sprites[cat.age])], (0, 0))
                for scar in cat.scars:
                    if scar in scars1:
                        new_sprite.blit(
        ...
        if not cat.dead:
            ...
            if cat.pelt.name == "Bat_Single":
                if cat.pelt.length == 'long' and cat.status not in [
                    ...
                    new_sprite.blit(
                        sprites.sprites['bat_lineartdead' +
                                        str(cat.age_sprites[cat.age] + 9)],
                        (0, 0))
                else:
                    new_sprite.blit(
